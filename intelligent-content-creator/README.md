...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/FNq1UQY9ma)
...
```sh
npx nx serve intelligent-content-creator
```

To create a production bundle:

```sh
npx nx build intelligent-content-creator
```

To see all available targets to run for a project, run:

```sh
npx nx show project intelligent-content-creator
```
